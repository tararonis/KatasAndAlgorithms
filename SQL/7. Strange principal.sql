-- https://www.codewars.com/kata/55fc061cc4f485a39900001f/train/sql
/* 
...
the number of open lockers after last sudent complets his activity. 
So input of the function is just one number which shows number of lockers and number of students.
For example if there are 1000 lockers and 1000 students in school then input 
...
SELECT
  n,
  CAST(FLOOR(POWER(n, 0.5)) as INT) as res
FROM 
  numofopenlockers;
