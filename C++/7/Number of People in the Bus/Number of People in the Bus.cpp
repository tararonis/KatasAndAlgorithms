// Katas-C++.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
unsigned int number(const std::vector<std::pair<int, int>>& busStops) {
	...
	{
		std::pair<int, int> cur = busStops[i];
		pas += cur.first;
		pas -= cur.second;
	}
	//for(auto i: busStops)  pas += i.first - i.second;
